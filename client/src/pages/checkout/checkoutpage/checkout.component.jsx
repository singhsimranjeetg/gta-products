...
const Checkout = ({ cartItems, total, clearEntireCart, createOrderStart, currentUser }) => {
  ...
  const onToken = (token) => {
    axios({
      ...
      .then((response) => {
        ...
        const orderDetails = response.data.success;
        createOrderStart(currentUser, cartItems, orderDetails);
        clearEntireCart();
    ...
    <div className="checkout-page">
      ...
      <h2 style={{ color: 'red' }}>
        *Please use the following test credit card for payments*
        <br />
        4242 4242 4242 4242 - Exp: 01/27 - CVC: 123{' '}
      </h2>
...
const mapDispatchToProps = (dispatch) => ({
  ...
  createOrderStart: (currentUser, cartItems, orderDetails) =>
    dispatch(createOrderStart({ currentUser, cartItems, orderDetails }))
});

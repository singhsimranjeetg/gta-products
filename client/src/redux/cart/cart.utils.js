...
export const addItemsToCart = (cartItems, cartItemsToAdd) => {
  ...
  const existingCartItems = cartItems.find(
    //it will return the first cartItems whose id matches the id of cartitem we wanna add
  ...
  if (existingCartItems) {
    ...
    return cartItems.map(
      (
        cartItem //map will return us new array and we need that in order to make comp render properly
      ) =>
